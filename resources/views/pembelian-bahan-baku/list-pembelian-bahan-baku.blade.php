        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-auto ml-auto">
                    <form class="navbar-form" action="{{ route('pembelian-bahan-baku.index') }}" method="GET">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        @foreach ($pembelianBahanBaku as $value)
                                            <tr>
                                                <td>{{$no}}</td>
                                                <td>{{$value->bulan}}</td>
                                                <td>{{$value->tahun}}</td>
                                                ...
                                                <td>
                                                    <form action="{{ route('pembelian-bahan-baku.destroy', $value) }}" method="post">
                                                        <a href="{{ route('pembelian-bahan-baku.edit', $value) }}" rel="tooltip" title="Edit" class="btn btn-white btn-link btn-sm"><i class="material-icons">edit</i></a>
                                                        @csrf
                                                        @method('delete')
                                ...
                                {{$pembelianBahanBaku->appends(Request::all())->links('vendor.pagination.custom')}}
                            </div>
                        </div>
                    </div>
                </div>
