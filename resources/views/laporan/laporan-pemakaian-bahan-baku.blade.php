                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header card-header-success">
                                <h4 class="card-title ">Laporan Pemakaian Bahan Baku Tahun {{Request::get('tahun')}}</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($laporan as $value)
                                                @php
                                                    $totalQty += $value->qty_bahan_baku;
                                                    $totalNominal += $value->nominal_bahan_baku;

                                                    $loop->iteration < count($laporan) ? $qty .= $value->qty_bahan_baku.',' : $qty .= $value->qty_bahan_baku;
                                                    
                                                    // $loop->iteration < count($laporan) ? $nominal .= $value->nominal_bahan_baku.',' : $nominal .= $value->nominal_bahan_baku;
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card card-chart">
                                <div class="card-header card-header-success">
                                <div class="ct-chart" id="laporanChart" data-series1="{{$qty}}" data-label="{{$label}}" style="overflow: auto;"></div>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Grafik Pemakaian Bahan Baku Tahun {{Request::get('tahun')}}</h4>
                                    <table>
                                        <tr>
                                            <td>
                                                <div id="aktual"></div>
                                            </td>
                                            <td>&nbsp;Quantity Pemakaian Bahan Baku</td>
                                        </tr>
                                        {{-- <tr>
                                            <td>
