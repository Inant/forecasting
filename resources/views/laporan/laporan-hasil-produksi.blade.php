                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header card-header-success">
                                <h4 class="card-title ">Laporan Hasil Produksi Tahun {{Request::get('tahun')}}</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($laporan as $value)
                                                @php
                                                    $totalQty += $value->qty_hasil_produksi;

                                                    $loop->iteration < count($laporan) ? $qty .= $value->qty_hasil_produksi.',' : $qty .= $value->qty_hasil_produksi;
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card card-chart">
                                <div class="card-header card-header-success">
                                <div class="ct-chart" id="laporanProduksiChart" data-series1="{{$qty}}" data-label="{{$label}}" style="overflow: auto;"></div>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Grafik Hasil Produksi Tahun {{Request::get('tahun')}}</h4>
                                    <table>
                                        <tr>
                                            <td>
                                                <div id="aktual"></div>
                                            </td>
                                            <td>&nbsp;Quantity Hasil Produksi</td>
                                        </tr>
                                        {{-- <tr>
                                            <td>
