        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-auto ml-auto">
                    <form class="navbar-form" action="{{ route('pemakaian-sparepart.index') }}" method="GET">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title ">List Pemakaian Bahan Penunjang</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        @foreach ($pemakaianSparepart as $value)
                                            <tr>
                                                <td>{{$no}}</td>
                                                <td>{{$value->bulan}}</td>
                                                <td>{{$value->tahun}}</td>
                                ...
                                {{$pemakaianSparepart->appends(Request::all())->links('vendor.pagination.custom')}}
                            </div>
                        </div>
                    </div>
                </div>
