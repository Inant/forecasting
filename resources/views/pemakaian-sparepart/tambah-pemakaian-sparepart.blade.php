                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title ">Tambah Data Pemakaian Bahan Penunjang</h4>
                            {{-- <p class="card-category">Semua User</p> --}}
                        </div>
                        <div class="card-body">
                                <form method="POST" action="{{ route('pemakaian-sparepart.store') }}">
                                    @csrf
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            has-error @enderror">
                                                ...
                                                <input type="number" step=".01" value="{{old('nominal_pemakaian')}}" class="form-control @error('nominal_pemakaian') is-invalid @enderror" name="nominal_pemakaian" autocomplete="off" />
                                                <span class="material-icons form-control-feedback">clear</span>
