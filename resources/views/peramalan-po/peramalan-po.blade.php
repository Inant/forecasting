                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header card-header-success">
                                <h4 class="card-title ">Perhitungan Peramalan</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @for ($indexPo = 0; $indexPo < count($purchaseOrder); $indexPo++)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{number_format($purchaseOrder[$indexPo]['qty_po'], 2, ',', '.')}} M<sup>3</sup></td>
                                                <td>{{number_format($smoothing1[$indexPo], 2, ',', '.')}}</td>
                                                <td>{{number_format($smoothing2[$indexPo], 2, ',', '.')}}</td>
                                                <td>{{number_format($smoothing3[$indexPo], 2, ',', '.')}}</td>
                                                <td>{{number_format($at[$indexPo], 2, ',', '.')}}</td>
                                                <td>{{number_format($bt[$indexPo], 2, ',', '.')}}</td>
                                                <td>{{number_format($ct[$indexPo], 2, ',', '.')}}</td>
                                                <td>{{number_format($peramalan[$indexPo], 2, ',', '.')}} M<sup>3</sup></td>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Kebutuhan Biaya Bahan Baku</th>
