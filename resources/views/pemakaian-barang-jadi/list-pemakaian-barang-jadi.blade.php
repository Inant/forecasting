        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-auto ml-auto">
                    <form class="navbar-form" action="{{ route('pemakaian-barang-jadi.index') }}" method="GET">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title ">List Pemakaian Barang Jadi</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        @foreach ($pemakaianBarangJadi as $value)
                                            <tr>
                                                <td>{{$no}}</td>
                                                <td>{{$value->bulan}}</td>
                                                <td>{{$value->tahun}}</td>
                                                ...
                                                <td>
                                                    <form action="{{ route('pemakaian-barang-jadi.destroy', $value) }}" method="post">
                                                        <a href="{{ route('pemakaian-barang-jadi.edit', $value) }}" rel="tooltip" title="Edit" class="btn btn-white btn-link btn-sm"><i class="material-icons">edit</i></a>
                                                        @csrf
                                                        @method('delete')
                                ...
                                {{$pemakaianBarangJadi->appends(Request::all())->links('vendor.pagination.custom')}}
                            </div>
                        </div>
                    </div>
                </div>
