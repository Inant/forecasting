                                    ...
                                    <div class="row mt-3">
                                            ...
                                            has-error @enderror">
                                                ...
                                                <select name="bulan" id="bulan" class="form-control" required>
                                                    ...
                                                    @foreach ($bulan as $item)
                                                        <option value="{{$item['bulan']}}" style="color: black" {{old('bulan', $bahanBaku->bulan) == $item['bulan'] ? 'selected' : '' }}>{{$item['nama']}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            has-error @enderror">
                                                ...
                                                <select name="tahun" id="tahun" class="form-control" required>
                                                    ...
                                                    @for ($y = 2018; $y <= date('Y'); $y++)
                                                        <option value="{{$y}}" style="color: black" {{old('tahun', $bahanBaku->tahun) == $y ? 'selected' : '' }}>{{$y}}</option>
                                                    @endfor
                                                </select>
                                                <span class="material-icons form-control-feedback">clear</span>
                                                @error('tahun')
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            has-error @enderror">
                                                ...
                                                <input type="number" step=".01" value="{{old('nominal_bahan_baku', $bahanBaku->nominal_bahan_baku)}}" class="form-control @error('nominal_bahan_baku') is-invalid @enderror" name="nominal_bahan_baku" autocomplete="off" />
                                                <span class="material-icons form-control-feedback">clear</span>
