                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title ">Tambah Data Pemakaian Bahan Baku</h4>
                                ...
                                <form method="POST" action="{{ route('bahan-baku.store') }}">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            has-error @enderror">
                                                <label class="control-label">Quantity Pemakaian Bahan Baku *</label>
                                                <div class="input-group">
                                                    <input type="number" step=".01" value="{{old('qty_bahan_baku')}}" class="form-control @error('qty_bahan_baku') is-invalid @enderror" name="qty_bahan_baku" autocomplete="off" />
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group label-floating @error('nominal_bahan_baku')
                                            has-error @enderror">
                                                <label class="control-label">Nominal *</label>
                                                <input type="number" step=".01" value="{{old('nominal_bahan_baku')}}" class="form-control @error('nominal_bahan_baku') is-invalid @enderror" name="nominal_bahan_baku" autocomplete="off" />
                                                <span class="material-icons form-control-feedback">clear</span>
                                                @error('nominal_bahan_baku')
                                                    <div class="invalid-feedback">
                                                        <h6>{{$message}}</h6>
                                                    </div>
                                                @enderror
